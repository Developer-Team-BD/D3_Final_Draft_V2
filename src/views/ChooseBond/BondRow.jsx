...
import { prettifySeconds, prettyVestingPeriod, secondsUntilBlock } from "../../helpers";


export function BondDataCard({ bond, popup, setPopup, setPopupData }) {
  ...
  const mint=(bond)=>{
    let popupData = [bond.balance, bond.displayUnits, bond.bondQuote, bond.payoutToken, bond.dailyEmission, bond.interestDue, bond.pendingPayout, bond.debtRatio, bond.bondDiscount]
    setPopup(!popup)
    setPopupData(item=> [1, ...popupData])
  }
...
export function BondTableData({ bond, setPopup, popup , setPopupData }) {
