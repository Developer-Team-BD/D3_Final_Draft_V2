...
const ChooseBond: React.FC<Props>=({popup, setPopup , setPopupData})=> {
              ...
              <TableBody>
                {bonds.map((bond) => {
                  ...
                  if (
                    ...
                    return <BondTableData setPopupData={setPopupData} popup={popup} setPopup={setPopup} key={bond.name} bond={bond} />;
                  }
                })}
              </TableBody>
            </Table>
              ...
              if (
                ...
                return (
                  <Grid item xs={12} key={bond.name}>
                    <BondDataCard setPopupData={setPopupData} popup={popup} setPopup={setPopup}  key={bond.name} bond={bond} />
                  </Grid>
                );
              }
            })}
